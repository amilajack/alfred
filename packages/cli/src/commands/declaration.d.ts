declare module 'format-package' {
  export default function formatPkg(pkg: Object, opts?: Object): Promise<Object>;
}
...
declare module 'git-config' {
  ...
  export default function gitConfig(cb: (err?: Error, config?: GitConfig) => void): Promise<GitConfig>
}
